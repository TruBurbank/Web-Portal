...
<body>
   ...
   <form method="POST" action="add.php">
                ...
                <div class="row form-group">
                    <div class="col-sm-2">
                        <label class="control-label modal-label">Student Task:</label>
                    </div>
                    <div class="col-sm-10">
                ...
                <div class="row form-group">
                    <div class="col-sm-2">
                        <label class="control-label modal-label">Check Performance of Interns:</label>
                    </div>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="csemstudtask" required>
                    </div>
                ...
                <div class="row form-group">
                    <div class="col-sm-2">
                        <label class="control-label modal-label">Interns News Task:</label>
                    </div>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="csemstudtask" required>
                    </div>
