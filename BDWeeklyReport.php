...
<body>
 ...
 <form method="POST" action="add.php">
                ...
                <div class="row form-group">
                    <div class="col-sm-2">
                        <label class="control-label modal-label">Schedule Weekly Meeting:</label>
                    </div>
                    <div class="col-sm-10">
                ...
                <div class="row form-group">
                    <div class="col-sm-2">
                        <label class="control-label modal-label">Take Feedback From Students Orally:</label>
                    </div>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="csemstudtask" required>
                    </div>
                ...
                <div class="row form-group">
                    <div class="col-sm-2">
                        <label class="control-label modal-label">Introduction to New Students:</label>
                    </div>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="csemstudtask" required>
                    </div>
                ...
                <div class="row form-group">
                    <div class="col-sm-2">
                        <label class="control-label modal-label">Fees pending Task Checking with Counsellor:</label>
                    </div>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="csemstudtask" required>
                    </div>
